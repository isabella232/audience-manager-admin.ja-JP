...
Lists the macros you can use to create [!DNL HTTP] data files. [!DNL HTTP] データを形式で送信 [!DNL JSON] します。
...
<table id="table_72A72EA63C3643FB84B47A76CD2CC1CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Experience Cloud ID. （MCIDはMarketing cloudの略で、Experience cloudのレガシー名です）。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>アクテ <a href="https://docs.adobe.com/help/en/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-api-reference/dcs-regions.html"> ィビティが開始され </a> たAudience Manager DCS領域。</p> </td> 
  </tr> 
  <tr> 
