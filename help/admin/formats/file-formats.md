...
これらのマクロはどの形式フィールドでも使用できます。例については、[ファイル形式マクロの例](../formats/file-format-examples.md)を参照してください。
    ...
    <ul id="ul_757DEB56E4F849768468F3C166B0D171"> 
     <li id="li_859E1F4F21D645519F150DC512B3EB1A"> <code>type</code>：数値 ID で識別される特性タイプ。この変数は次の値を返します。 
      <ul id="ul_C9839266783D42CCADAAC3FEA33BE4D7"> 
       ...
       <li id="li_831FF929BF50434C8804C13E5786DF79"> <code>ルール</code> ・ベースの特性(リアルタイム、(DCSを通じ <span class="wintitle"> て </span>)。 </li> 
      </ul> </li> 
